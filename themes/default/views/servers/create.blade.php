...
<div class="min-h-screen bg-primary-950 p-8">
    ...
    <div class="max-w-screen-xl mx-auto" x-data="serverApp()">
        <form action="{{ route('servers.store') }}" method="post" x-on:submit="submitClicked = true" id="serverForm">
            ...
            <!-- Products Grid -->
            <div x-show="selectedLocation != null" 
                ...
                <template x-for="product in products" :key="product.id">
                    <div class="card">
                        <div class="p-4 sm:p-6">
                            ...
                            <!-- Resources -->
                            <div class="space-y-2 sm:space-y-3 mb-4 sm:mb-6 text-sm">
                            ...
                            <div class="mb-4 sm:mb-6">
                                <p class="text-xs sm:text-sm text-zinc-400" x-text="product.description"></p>
                            </div>
