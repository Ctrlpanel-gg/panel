                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a class="text-muted"
                                href="{{ route('admin.activitylogs.index') }}">{{ __('Activity Logs') }}</a>
                        </li>
                    </ol>
                </div>
            </div>
                ...
                <div class="col-lg-4">
                    ...
                    @else
                        <div class="callout callout-danger">
                            ...
                            <p>{{ __('Are cronjobs running?') }} <a class="text-primary" target="_blank"
                                    href="https://ctrlpanel.gg/docs/getting-started/install#crontab-configuration">{{ __('Check docs') }}</a>
                            </p>
                        </div>
                    @endif
                </div>
                                                    ...
                                                    @foreach ($properties['attributes'] as $attribute => $newValue)
                                                        @if (array_key_exists($attribute, $properties['old']) && !is_null($newValue) && !is_array($newValue))
                                                            <li>
                                                                ...
                                                                @else
                                                                    {{ $properties['old'][$attribute] }} <i
                                                                        class="fas fa-long-arrow-alt-right mx-1"></i>
                                                                    {{ $newValue }}
                                                                @endif
                                                            </li>
                                                        @endif
