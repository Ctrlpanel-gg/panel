          ...
          <div class="row">
            ...
            <div class="col-lg-6">
              <div class="row">
                ...
                <div class="col-lg-8">
                  <span style="max-width: 250px;" class="d-inline-block text-truncate">
                    {{ $product->memory == 0 ? 'Unlimited' : $product->memory }}
                  </span>
                </div>
              </div>
            </div>
            ...
            <div class="col-lg-6">
              <div class="row">
                ...
                <div class="col-lg-8">
                  <span style="max-width: 250px;" class="d-inline-block text-truncate">
                    {{ $product->cpu == 0 ? 'Unlimited' : $product->cpu }}
                  </span>
                </div>
              </div>
            </div>
            ...
            <div class="col-lg-6">
              <div class="row">
                ...
                <div class="col-lg-8">
                  <span style="max-width: 250px;" class="d-inline-block text-truncate">
                    {{ $product->swap == -1 ? 'Unlimited' : $product->swap }}
                  </span>
                </div>
              </div>
            </div>
            ...
            <div class="col-lg-6">
              <div class="row">
                ...
                <div class="col-lg-8">
                  <span style="max-width: 250px;" class="d-inline-block text-truncate">
                    {{ $product->disk == 0 ? 'Unlimited' : $product->disk }}
                  </span>
                </div>
              </div>
            </div>
