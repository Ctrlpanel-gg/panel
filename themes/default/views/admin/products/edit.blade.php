                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <select id="billing_period" style="width:100%" class="custom-select"
                                                ...
                                                <option value="hourly" @selected($product->billing_period == 'hourly')>{{ __('Hourly') }}
                                                </option>
                                                <option value="daily" @selected($product->billing_period == 'daily')>{{ __('Daily') }}
                                                </option>
                                                <option value="weekly" @selected($product->billing_period == 'weekly')>{{ __('Weekly') }}
                                                </option>
                                                <option value="monthly" @selected($product->billing_period == 'monthly')>{{ __('Monthly') }}
                                                </option>
                                                ...
                                                <option value="half-annually" @selected($product->billing_period == 'half-annually')>
                                                    {{ __('Half Annually') }}</option>
                                                <option value="annually" @selected($product->billing_period == 'annually')>{{ __('Annually') }}
                                                </option>
                                            </select>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input
                                                value="{{ $product->minimum_credits ? Currency::formatForForm($product->minimum_credits) : null }}"
                                        ...
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" value="1"
                                                    id="oom_killer" name="oom_killer" @checked($product->oom_killer)>
                                                <label class="custom-control-label"
                                                    for="oom_killer">{{ __('OOM Killer') }}
                                                    <i data-toggle="popover" data-trigger="hover"
