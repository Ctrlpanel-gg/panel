                            ...
                            <form action="{{ route('admin.coupons.update', $coupon->id) }}" method="POST">
                                ...
                                <div class="form-group">
                                    <div class="p-0 mb-3 custom-control">
                                        ...
                                        <select name="type" id="type"
                                            ...
                                            <option value="amount" @if ($coupon->type == 'amount') selected @endif>
                                                {{ __('Amount') }}</option>
                                        </select>
                                        @error('type')
                                            <div class="text-danger">
                                ...
                                <div class="form-group">
                                    <label for="max_uses_per_user">
                                        ...
                                        <i data-toggle="popover" data-trigger="hover"
                                            data-content="{{ __('How many times a single user can redeem this coupon. Set to -1 for unlimited.') }}"
                                            class="fas fa-info-circle">
                                        </i>
                                    </label>
                                    <input name="max_uses_per_user" id="max_uses_per_user" type="number" step="1"
                                        ...
                                        value="{{ $coupon->max_uses_per_user }}" required>
                                    <small
                                ...
                                <div class="d-flex flex-column input-group form-group date" id="expires_at"
                                    ...
                                    <div class="d-flex">
                                        <input value="{{ $expired_at ?? '' }}" name="expires_at"
