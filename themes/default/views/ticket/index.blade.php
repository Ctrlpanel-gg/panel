...
<div class="min-h-screen bg-primary-950 p-8">
    ...
    <div class="w-full mb-8">
        <div class="glass-panel p-6">
            <div class="flex justify-between items-center">
                ...
                <a href="{{ route('ticket.new') }}" class="btn btn-primary @cannot('user.ticket.write') opacity-50 cursor-not-allowed @endcannot">
    ...
    <div class="w-full">
        ...
        @if(isset($ticketsettings) && $ticketsettings->information)
