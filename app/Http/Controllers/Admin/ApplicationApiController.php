    ...
    public function dataTable(Request $request)
    {
        ...
        return datatables($query)
            ->addColumn('actions', function (ApplicationApi $apiKey) {
                return '
                    <a data-content="'.__('Edit').'" data-toggle="popover" data-trigger="hover" data-placement="top" href="'.route('admin.api.edit', $apiKey->token).'" class="action-btn glow-border info"><i class="fas fa-pen"></i></a>
