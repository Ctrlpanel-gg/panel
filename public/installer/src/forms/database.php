...
if (isset($_POST['checkDB'])) {
    ...
    try {
        ...
        header("LOCATION: {$protocol}://{$host}/installer/index.php?step=3&message=" . $th->getMessage() . " <br>Please check the installer.log file in " . dirname(__DIR__,4) . '/storage/logs' . "!");
        exit();
    }
