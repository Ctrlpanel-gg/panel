...
class ConvertFloatColumnsToIntegers extends Migration
{
    public function up()
    {
        // added temp columns for conversion to integers
        ...
        // convertion decimal values to integers
    ...
    {
        // added temp columns for conversion to decimal values
        Schema::table('coupons', function (Blueprint $table) {
        ...
        // convertion of integers back to decimal values
